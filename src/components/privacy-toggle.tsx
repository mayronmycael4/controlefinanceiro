...
export function PrivacyToggle() {
  ...
  function toggle() { const next = !hidden; setHidden(next); window.localStorage.setItem("privacy-mode", next ? "hidden" : "visible"); document.documentElement.dataset.privacyHidden = next ? "true" : "false"; }
